...
| brand-divergence | HARD | pass | 20 | distance 0.1410 >= 0.11 (ground normalised to #FFFFFF); 5/5 structural properties differ (padding, borderRadius, letterSpacing, boxShadow, textTransform); 20 block renders, no overflow at 375px; contact sheet in bench/gallery/ |
| budget | HARD | pass | 11 | gzipped agent.js: 13471B (cap 15975B). config-fetch-to-first-paint: 61.8ms (cap 400ms), widget stamped at 235.3ms. |
