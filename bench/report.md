...
| brand-divergence | HARD | pass | 20 | 0 | distance 0.1321 >= 0.11 (ground normalised to #FFFFFF); 5/5 structural properties differ (padding, borderRadius, letterSpacing, boxShadow, textTransform); 20 block renders, no overflow at 375px; contact sheet in bench/gallery/ |
...
| budget | HARD | FAIL | 0 | 1 | H6 budget: gzipped agent.js is 16409B, over the 15975B cap — H6 budget: gzipped agent.js is 16409B, over the 15975B cap |
| scorecard | SOFT | pass | 68 | 0 | 44/68 axes green across 17 landed tasks. Open first: T14 (1/4), T9 (1/4), then T2 (2/4), T12 (2/4), H1+H3 (2/4), T5 (2/4), T7 (2/4), T15 (2/4). NOT judged: T13 (landed, held out of this judging run). Judge is uncalibrated — advisory only. Rationales: bench/scorecard.json. |

7 checks, 1 HARD failures.
